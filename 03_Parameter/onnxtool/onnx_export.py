...
from onnxtool.onnx_node import OnnxNode
from onnxtool.onnx_tensor import OnnxTensor
...
#     @property
#     def previous_node(self) -> Tuple[OPNode, ...]:  # pylint: disable=missing-function-docstring
...
class OnnxGraph:  # pylint: disable=missing-class-docstring
    def __init__(self, onnx_graph_proto: GraphProto):
        ...
        #     print(node.name)
        #     print("    input:")
        #     for i, input_name in enumerate(node.input_values):
        #         print("        ", input_name)
        #     print("    output:")
