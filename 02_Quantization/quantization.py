# ------------------------------------------------------------
# PPQ 最佳实践示例工程，在这个工程中，我们将向你展示如何充分调动 PPQ 的各项功能 ppq == 0.6.5.1
# ------------------------------------------------------------
...
pretrained_dict = torch.load(TORCH_MODEL_PATH, map_location = device)
...
with ENABLE_CUDA_KERNEL():
    quantized = quantize_torch_model(
        ...
        onnx_export_file=ONNX_INTERLATER_OUTPUT_PATH, device=DEVICE, verbose=0)
...
# ------------------------------------------------------------
# ONNX_OUTPUT_PATH = '/home/caixc/Documents/Work/Project/NNA/CNN_Quantification/mnist_c6/data/models/model.onnx'
